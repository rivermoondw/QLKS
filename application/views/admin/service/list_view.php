        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table id="example2" class="table table-hover">
                    ...
                    ?>
                    <tr>
                        <td><input type="checkbox" name="checkbox[]" value="<?php echo $val['service_id']; ?>"></td>
                        <td><?php echo htmlspecialchars($val['service']); ?></td>
                        <td><?php echo htmlspecialchars($val['price']); ?></td>
                        <td>
                            <a href="<?php echo base_url(); ?>admin/service/edit/<?php echo $val['service_id']; ?>"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Sửa</button></a>
                            <a href="<?php echo base_url(); ?>admin/service/del/<?php echo $val['service_id']; ?>"><button type="button" class="btn btn-default btn-xs del-btn"><i class="fa fa-times"></i> Xóa</button></a>
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <div class="box-footer no-border">
                ...
                <a href="<?php echo base_url(); ?>admin/service/add"><button type="button" class="btn btn-default"><i class="fa fa-plus"></i> Thêm dịch vụ</button></a>
