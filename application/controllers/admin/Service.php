...
class Service extends Admin_Controller
{
    ...
    {
        parent::__construct();
        $this->data['page_title'] = 'Quản lý dịch vụ';
    ...
    public function index($page = 1)
    {
        ...
        $this->data['content_header'] = 'Danh sách dịch vụ';
  ...
  $(function () {
    ...
    $(".select2").select2({
        ...
        if ($this->input->post('submit')) {
            $this->form_validation->set_rules('service', 'Tên dịch vụ', 'required|trim');
            $this->form_validation->set_rules('price', 'Giá dịch vụ', 'required|trim');
